...
"""
from src.data_preparation import RAW_DATA_PATH, DataPreparation, prepare_data

class DataService:
    @staticmethod
    def prepare_data(data_path: str = RAW_DATA_PATH, test_size: float = 0.3):
        return prepare_data(data_path=data_path, test_size=test_size)

    @staticmethod
    def get_preparer(data_path: str = RAW_DATA_PATH):
